...
window.__fixture={events:{},drops:[],submitCount:0,nextClickCount:0,submitClickCount:0,microsoftSponsorshipClicks:0,record(id,event){const key=id+':'+event;this.events[key]=(this.events[key]||0)+1}};
