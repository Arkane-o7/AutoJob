...
function formMarkup(type) {
  ...
  const answerMemoryFields = type === "react-dropzone" ? `
    <div class="field"><div id="registration-label">Reg No. *</div><input id="registration-number" aria-labelledby="registration-label" data-initial-value="9030065423"></div>
    <div class="field"><div id="full-name-label">Name *</div><input id="google-full-name" aria-labelledby="full-name-label" data-initial-value="9030065423"></div>
    <div class="field"><div id="personal-email-label">Personal Email ID *</div><input id="personal-email" type="email" autocomplete="email" aria-labelledby="personal-email-label"></div>
    <div class="field"><div id="college-email-label">College email id *</div><input id="college-email" aria-labelledby="college-email-label"></div>
    <div class="field"><div id="preserved-college-email-label">University email id *</div><input id="preserved-college-email" type="email" autocomplete="email" aria-labelledby="preserved-college-email-label" value="ada@example.test" data-initial-value="ada@example.test"></div>
    <div class="field"><div id="institutional-email-label">Institutional email *</div><input id="institutional-email" type="email" autocomplete="email" aria-labelledby="institutional-email-label"></div>
    <div class="field"><div id="tenth-label">10th % *</div><input id="tenth-percentage" aria-labelledby="tenth-label" data-initial-value="9030065423"></div>
    <div class="field"><div id="twelfth-label">12th % *</div><input id="twelfth-percentage" aria-labelledby="twelfth-label" data-initial-value="9030065423"></div>
    <div class="field"><div id="degree-label">Degree &amp; specialization *</div><input id="degree-specialization" aria-labelledby="degree-label" data-initial-value="9030065423"></div>` : "";
  ...
  return `${ATS_MARKUP[type] || ""}<form id="fixture-form" class="fixture-form" novalidate>
    ...
    ${country}${workdayDate}${microsoftContact}${microsoftQuestions}${learnedQuestion}${answerMemoryFields}
...
const microsoftSponsorship=document.querySelector('#microsoft-sponsorship');const microsoftSponsorshipList=document.querySelector('#microsoft-sponsorship-list');if(microsoftSponsorship&&microsoftSponsorshipList){microsoftSponsorship.addEventListener('click',()=>{window.__fixture.microsoftSponsorshipClicks++;const open=microsoftSponsorship.getAttribute('aria-expanded')!=='true';microsoftSponsorship.setAttribute('aria-expanded',String(open));microsoftSponsorshipList.hidden=!open})}
document.querySelector('#microsoft-stray-no')?.addEventListener('click',()=>window.__fixture.microsoftStrayOptionClicks++);
window.bumpMicrosoftControlledField=()=>{const group=document.querySelector('#microsoft-sponsorship-group');if(!group)return;const noise=document.createElement('span');noise.textContent='controlled rerender';group.append(noise);queueMicrotask(()=>noise.remove())};
