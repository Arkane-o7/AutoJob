...
function formMarkup(type) {
  ...
  const microsoftContact = type === "microsoft" ? `<div role="group" class="form-section"><label for="Contact_Information_q_address">Address</label><input id="Contact_Information_q_address" type="text" aria-required="true"><label for="Contact_Information_q_addressLine2">Address Line 2</label><input id="Contact_Information_q_addressLine2" type="text"><label for="Contact_Information_q_city">City</label><input id="Contact_Information_q_city" type="text" aria-required="true"><label for="Contact_Information_q_zip">Postal Code/Zip</label><input id="Contact_Information_q_zip" type="text" aria-required="true"><div id="microsoft-state-label">State</div><input id="microsoft-state" class="select-module_select-input__fixture" type="text" role="combobox" aria-labelledby="microsoft-state-label" aria-controls="microsoft-state-list" aria-expanded="false" aria-required="true"><ul id="microsoft-state-list" role="listbox" hidden><li role="option" aria-selected="false">Greater London</li><li role="option" aria-selected="false">West Midlands</li></ul></div>` : "";
